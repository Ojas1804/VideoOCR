...
Samples frames from a video at a reduced FPS to limit processing work.
"""
...
def extract_frames(
    ...
    """
    Yield (frame_number, timestamp_seconds, frame_bgr) for every sampled frame.

    Args:
        video_path:  Path to the video file.
        sample_fps:  How many frames per second to sample (e.g. 2 or 4).
                     Must be <= the video's native FPS.
